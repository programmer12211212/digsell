    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, db_column='phone_number', max_length=20, null=True, unique=True)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/')),
                ('role', models.CharField(choices=[('GUEST', 'Guest'), ('USER', 'User'), ('SELLER', 'Seller'), ('MODERATOR', 'Moderator'), ('ADMIN', 'Admin'), ('SUPER_ADMIN', 'Super Admin')], default='USER', max_length=20)),
                ('loyalty_level', models.CharField(choices=[('BRONZE', 'Bronze'), ('SILVER', 'Silver'), ('GOLD', 'Gold'), ('PLATINUM', 'Platinum'), ('DIAMOND', 'Diamond'), ('VIP', 'VIP')], default='BRONZE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_balance', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
